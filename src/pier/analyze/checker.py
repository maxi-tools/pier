...
from pier.analyze.backend import query_agent
from pier.analyze.models import (
    QualityCheckResult,
...
PROMPTS_DIR = Path(pier.analyze.__file__).parent / "prompts"
...
async def run_check(
    ...
    if not task_paths.is_valid():
        raise ValueError(
            ...
            f"For trial analysis, use 'pier analyze <trial-dir>' instead."
        )
